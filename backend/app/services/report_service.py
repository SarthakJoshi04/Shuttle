...
def report_vehicle(
    ...
    Args:
        vehicle_data (ReportedVehicleCreate): Vehicle details to report.
        user_id (int): ID of the user reporting the vehicle.
        db (Session): SQLAlchemy database session.

    Returns:
        dict: Confirmation message with report details.

    Raises:
        HTTPException: If vehicle is already reported or database error occurs.
    """
    try:
